...
public class TeleportSeers extends LeafTask {
    ...
    public TeleportSeers() { bot = (SmartAgility) Environment.getBot(); }


    @Override
    public void execute() {
        if(Magic.CAMELOT_TELEPORT.getComponent().getSpriteId() == Magic.CAMELOT_TELEPORT.getSpriteIdWhenAvailable())
        {
