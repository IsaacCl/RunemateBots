package com.SmartMTA;

import com.SmartMTA.branches.lobby.ShouldStartBot;
import com.SmartMTA.state.AlchemistGameState;
import com.SmartMTA.userInterface.MTABotUIController;
...
public class MTABot extends TreeBot implements EmbeddableUI, ChatboxListener {
    ...
    public ObjectProperty<? extends Node> botInterfaceProperty() {
        if (botInterfaceProperty == null) {
            ...
            try {
                Node node = loader.load(Resources.getAsStream("com/SmartMTA/userInterface/MTABotUIView.fxml"));
