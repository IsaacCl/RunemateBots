...
public class HasTaskOverChatbox extends BranchTask {
    ...
    public TreeTask successTask() {
        var allChatboxTasks = new ArrayList<>(Arrays.asList(
                ...
                new ChatboxTask((text) -> text.contains("Click on your dagger to equip it"), new ClickItem("Dagger")),
                ...
                new ChatboxTask((text) -> text.contains("If you need to go over any of what you learnt here, just talk to the combat"), new InteractObject(new SmartObject(new Area.Rectangular(new Coordinate(3120, 3123, 0), new Coordinate(3122, 3123, 0)), "Bank booth", "GameObject"))),
                ...
                new ChatboxTask((text) -> text.contains("Polls are run periodically") || text.contains("Talk to the Account Guide"), new InteractObject(new SmartObject(new Area.Rectangular(new Coordinate(3125, 3124, 0), new Coordinate(3127, 3124, 0)), "Account Guide", "Npc"))),
                new ChatboxTask((text) -> text.contains("Account Management menu"), new OpenInterface(ControlPanelTab.ACCOUNT_MANAGEMENT)),
                new ChatboxTask((text) -> text.contains("Continue moving through the next door") || text.contains("Follow the path to the chapel") || text.contains("with Brother Brace"), new InteractObject(new SmartObject(new Area.Rectangular(new Coordinate(3126, 3106, 0), new Coordinate(3123, 3107, 0)), "Brother Brace", "Npc"))),
